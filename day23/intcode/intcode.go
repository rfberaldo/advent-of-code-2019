...
// Clone returns a new IntCode; feedback, input and output are not copied.
func (ic *IntCode) Clone() *IntCode {
	return &IntCode{
		name:     "clone of " + ic.name,
		pgrm:     slices.Clone(ic.pgrm),
...
func (ic *IntCode) WaitingInput() bool {
	return ic.waitingInput
}
